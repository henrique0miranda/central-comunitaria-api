...
class RelatorioRepository {
    ...
    `);
        ...
        // Tempo médio de conclusão (em dias) usando a query com funções do SQLite (julianday converte data para Float de dias)
    ...
    `;
        ...
        if (dataFim) {
            // adiciona 23:59:59 caso so tenha vindo a data
            baseQuery += ` AND c.criado_em <= ?`;
